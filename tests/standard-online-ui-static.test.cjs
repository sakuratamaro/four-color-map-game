...
test("UI derives its canonical and experimental card metadata from the generated registry", () => {
  ...
  assert.match(html, /standard-skill-registry\.generated\.js\?v=20260912-2[\s\S]+app\.js\?v=20260914-2/);
