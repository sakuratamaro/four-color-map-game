...
test("candidate verification SQL is read-only and covers every migration 006-013 boundary", () => {
  ...
  for (const boundary of ["card_sale", "matchmaking_recruit", "matchmaking_find", "accept_cpu", "load_room_v2", "cpu_rematch", "cosmetic", "cleanup_expired_batched", "room_snapshot_v2"]) {
