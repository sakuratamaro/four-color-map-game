(function initStandardOnlineClient(root, factory) {
  ...
  const PUBLIC_FUNCTION_ERRORS = Object.freeze({
    ...
    NO_COLOR_DECLARATION_RETIRED: "「塗れる色なし」の申告は廃止されました。色操作カードを確認し、自分で決めた場合は投了してください。",
    ...
    INVALID_CORNER_BLOOM_TARGET: "選んだマスは、いま作っているエリアの角膨張に使えません。白い枠の内側を選び直してください。",
    NO_CORNER_BLOOM_CANDIDATE: "このマスの周りには角膨張できる空きがありません。カード・手番は減っていません。別のマスを選んでください。",
    COLORED_CORNER_BLOOM_NOT_SUPPORTED: "この対戦は以前のルールで始まっているため、彩色済みエリアの角膨張には対応していません。白い枠の渡すエリアで使うか、新しい対戦でお試しください。",
    INVALID_COLORED_CORNER_BLOOM_TARGET: "選んだセルは、いま彩色済みエリアの角膨張に使えません。紫の枠内から選び直してください。",
    INVALID_COLORED_CORNER_BLOOM_MACRO: "選んだセルとエリアの位置が一致しません。最新の盤面の紫の枠内から選び直してください。",
    NO_COLORED_CORNER_BLOOM_CANDIDATE: "このセル周辺には広げられる角がありません。カード・手番は減っていません。紫の枠内の別のセルを選んでください。",
    INVALID_OUTGOING_SELECTION: "渡すエリアの選択を確認できませんでした。白い枠を必要なマス数だけ選び直してください。カード・手番は減っていません。",
    NO_MICRO_BLOOM_CANDIDATE: "選んだエリアには、ひとふくらみで斜めのエリアへ接続できる角がありません。カード・手番は減っていません。別の場所を選び直してください。",
    INSUFFICIENT_COINS: "コインが不足しています。最新の残高と必要数を確認してください。",
