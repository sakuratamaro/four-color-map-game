...
- 公開製品コードは `3dea0ed`。Windows `34407352376`とPages `34408261449`が同SHAで成功し、0マス時の全開始候補に加え、各セル選択直後の2／3／4色接触演出まで累積している。公開390pxでonline app v16・style v10、演出DOM、横overflow 0を確認した。次の変更も専用clean worktreeでのみ統合する。
