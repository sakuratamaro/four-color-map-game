...
| 項目 | 現在状態 | 公開証拠と未達境界 |
| --- | --- | --- |
| 現在の公開製品 | PUBLIC_VERIFIED | `4508fb4`、Windows `34379857918` attempt 2、Pages `34382383719`、candidate preflight `ok:true`、公開PC・390pxでcompact quiz巡回、overflow 0、console 0 |
