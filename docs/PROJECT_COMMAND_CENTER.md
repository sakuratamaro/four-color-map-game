...
| P1 | alpha.4彩色済みエリア角膨張 | ルール＋CPU＋Edge＋UX＋司令塔 | PUBLIC_VERIFIED | engine `90e718b`、direct-cell `26a4161`、Edge deployment 24。全versionのカード→microcell即発動、対象外通信0、preparedOutgoing継続、server不成立後の再選択、専用高倍率zoomを実装。focused非browser 138/138、ローカル実Edge/Chrome各6/6、Windows `34065224136`、Pages `34065705946`、公開candidate preflight、390px overflow 0、console 0、独立再監査P0/P1/P2なし。DB・migration・RPC・secret変更なし |
...
| P1 | CPU敗北表情・理由別台詞 | 演出＋UX＋素材 | PUBLIC_VERIFIED | `d06f34d`の公開理由別台詞へoriginal 10人atlasを追加した`21b58c6`を公開。第三者素材は全てHOLD。Windows `34142743062`、Pages `34165800064`、公開CPU戦の`portraitStatus=ready`、fallback、PvP非表示、reload再演なしを確認 |
...
| UDL-20260906-004 | CPUイラスト素材を採用 | original 10人atlasだけをrepoへ収録し、第三者素材はHOLD | 10人存在、RGBA透明spare、fallback、PvP非表示、reload再演なし、外部URL/credit不要 | CPU roster、公開commentary | 素材＋UX＋司令塔 | CPU art P1 | PUBLIC_VERIFIED | `21b58c6` | `21b58c6` | `34165800064` | Windows `34142743062`、公開app/style/portraits `20260908-1`、yuzu normal ready、console 0 | `01a07462`,`01a0762c`,`01a06c79` | 第三者WebP/crop案をoriginal atlasでSUPERSEDED | YES |
...
| UDL-20260906-007 | CPU敗北理由別の表情と台詞 | 公開理由別台詞、original敗北表情、既存固有台詞を重複させない | reload再演なし、private情報なし、画像fallback、PvP非表示 | UDL-004、UDL-006、既存`a5f84e8/8124d05` | 演出＋UX | Text with P0, art P1 | PUBLIC_VERIFIED | `d06f34d`＋`21b58c6` | `21b58c6` | `34165800064` | Windows `34142743062`、公開CPU戦でnormal portrait ready、公開preflight、console 0。terminal/fallback/PvPは正式実browser契約で確認 | `01a07628`,`01a06c79` | 第三者候補はHOLD | YES |
...
| UDL-20260907-021 | クイズのボタン自体を衝突移動 | 大枠内で大きいbutton全体を壁反射・相互衝突させる | hover/focus/touch即停止、feedback中停止、DOM順keyboard、hidden/handoff/hint/pending/reduced-motion停止、resize再配置 | server quiz exactly-once boundary | クイズ＋UX＋a11y | P0 public UX recovery | PUBLIC_VERIFIED | `345c472` | `345c472` | `34167465748` | Windows `34166855484`。公開desktopで6 buttonが各9.1–12.0px移動、bounds内、overlap 0、hover/focus中2.2秒不変、回答1回、console 0。390px/reduced-motionは正式実browserで確認 | `01a06c79` handoff | fixed hitbox＋label driftをSUPERSEDED | YES |
