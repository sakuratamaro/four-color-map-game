...
- 統合基点は `origin/main` とし、現在の公開製品ロジックは `cc96350`、公開commitは `a4c6490`。
...
| 公開済み現候補 | 製品`cc96350`／公開`a4c6490` | 初手ガイド、CPU勝利戦績表示、6枚準備、待ち時間なしの10人Standard CPU開始を含む。公開UIでCPU初手まで確認済み |
