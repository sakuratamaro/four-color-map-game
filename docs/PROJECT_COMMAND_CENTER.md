...
- 公開製品コードは `4a8cb28`。Windows `34404697454`とPages `34405690053`が同SHAで成功し、封印中の元色保持に加え、0マス時の実選択可能な全開始候補まで累積している。公開390pxでonline app v15・style v10、全候補／自動選択なしの案内、横overflow 0を確認した。次の変更も専用clean worktreeでのみ統合する。
