...
| P1 | 対戦を主役にする情報設計 | UX | LOCAL_VERIFIED | 5タブ化し、ホームの主CTAを「対戦を始める」に固定。公開後の実端末確認待ち |
...
| 統合済み次候補 | `codex/standard-release-command@8b595c9` | 5タブ、クイズ・演出、debug隔離、no-color自動終局を統合。browser/live gate後に公開判断 |
