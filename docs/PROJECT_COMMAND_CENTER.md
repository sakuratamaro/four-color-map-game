...
- 統合基点は `origin/main` とし、現在の公開基点は `afc89af`。legal-recolor LAB公開`3fb3ef8`と390px盤面導線`2a1d2ef`に、最新手スポットライトと手番到着beatを累積している。
...
| 区分 | 対象 | 方針 |
| --- | --- | --- |
| 正本 | `origin/main` | 公開基点は`afc89af`（legal-recolor LAB公開`3fb3ef8`、390px盤面導線`2a1d2ef`、最新手スポットライトを累積）。migration `202609050001`–`202609050007`＋`202609060001`–`202609060002`、Edge deployment 17、Pages run `33993298423`まで公開確認済み |
| 現在の統合床 | `codex/standard-release-command` | `main`と同じ公開製品。証拠台帳追補をこの床で同期する |
| 公開済み現候補 | `afc89af`（`2a1d2ef`とLAB公開`3fb3ef8`を含む） | active-room復帰、isolated legal-recolor LAB、390px盤面導線、最新手スポットライトを含む。公開app v25/client+intents v17/style v24、Windows `33992923690`、Edge deployment 17、DB 70/70、LAB canary 23/23、Pages `33993298423`、candidate preflightを確認済み |
...
| 二端末P0 handoff | PENDING | `afc89af`の対人/CPU/LAB完走、390px盤面導線、最新手スポットライト、確定接触feedback、公開戦術trace、開始前取りやめ、終局理由、Quick継続、途中再読込、報酬→ガチャ→6枚再編成→再戦、永続化だけを残件として回収 |
