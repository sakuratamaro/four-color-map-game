...
3. fresh `origin/main` が候補の祖先であることを再確認してforceなしでfast-forwardする。同一SHAのPages成功後、online app `app.js?v=20260912-40`、メモ4 JS `v=20260912-1`、CSS `v=20260912-2` を含め、公開byte/SHAを固定候補に突き合わせる。
